...
generate_criteria_agent = Agent(
    ...
    instructions="You are a helpful assistant that generates success criteria. Given a goal and search results, create a list of specific, measurable success criteria. Return your response as a JSON array of objects with 'criteria', 'reasoning', and 'rating' (1-10) fields."
)

evaluate_criteria_agent = Agent(
    name="CriteriaEvaluator", 
    instructions="You are an expert evaluator. Given a goal, search results, and proposed criteria, select the most relevant and impactful criteria. Return your response as a JSON array of the selected criteria objects with 'criteria', 'reasoning', and 'rating' fields."
)
